...
<div class="row">
    ...
    <form:form method="post" action="/DevTracker/InsertCreateLogin" modelAttribute="createLogin" >
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well">
                <h2><i class="glyphicon"></i> Login - Confirmation</h2>
            ...
            <div class="box-content">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                            <code class="capsText">${createLogin.userName}</code>
                        </td>
                    </tr>
                    <tr>
                        <td>
