...
<div class="row">
            ...
            <div class="box-content">
                <div class="box-content">
                    <ul class="dashboard-list">
                        <li>
                            <a href="#">
                                <img class="dashboard-avatar" alt="Gerald"
                                     src="http://www.gravatar.com/avatar/03ad5ff5f853a6621083aa2b04439ce3.png"></a>
                            <strong>Name:</strong> <a href="#">Gerald
                            </a><br>
                            <strong>Since:</strong> 4/4/2014<br>
                            <strong>Status:</strong> <span class="label-success label label-default">Approved</span>
                        </li>
                        <li>
                            <a href="#">
                                <img class="dashboard-avatar" alt="Jerry"
                                     src=""></a>
                            <strong>Name:</strong> <a href="#">Jerry
                            </a><br>
                        ...
                        <li>
                            <a href="#">
                                <img class="dashboard-avatar" alt="Shankar"
                                     src=""></a>
                            <strong>Name:</strong> <a href="#">Shankar  </a><br>
                            <strong>Since:</strong> 25/05/2014<br>
                            <strong>Status:</strong> <span class="label-default label label-danger">Banned</span>
                        </li>
                        <li>
                            <a href="#">
                                <img class="dashboard-avatar" alt="Sandeep"
                                     src=""></a>
                            <strong>Name:</strong> <a href="#">Sandeep</a><br>
                            <strong>Since:</strong> 17/05/2014<br>
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            ...
            <div class="box-content">
                <div id="donutchart" style="height:332px"></div>
            </div>
        </div>
    </div>
</div><!--/row-->
